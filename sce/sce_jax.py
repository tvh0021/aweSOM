## Statistically Combined Ensemble (SCE) code for 1D data (or non-geometrical data), originally described in Bussov & Nattila (2021)
...
def nested_loop(all_data, number_of_clusters):
    ...
    for i in range(len(runs)):
        ...
        for cid in range(nids):
            ...
            total_mask = jnp.zeros((n), dtype=float)
