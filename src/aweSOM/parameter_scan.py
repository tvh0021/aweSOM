...
parser.add_argument("--script_location", type=str, dest='script_location', default='~/git_repos/aweSOM/som/som3d.py')
parser.add_argument("--features_path", type=str, dest='features_path', default='/mnt/ceph/users/tha10/SOM-tests/lr-d3x128/')
parser.add_argument("--file", type=str, dest='file', default='features_3j2b2e0r_5000.h5')
parser.add_argument('--save_neuron_values', dest='save_neuron_values', action='store_true', help="Save the neuron values to a file")
parser.add_argument("--xdim", type=list[int], dest='xdim', default=[18, 20, 22, 24])
